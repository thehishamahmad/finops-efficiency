const OPTIMIZATION_AREAS = {
  visibility: {
    title: "Financial Accountability & Reporting",
    description: "Improve cost ownership, showback or chargeback visibility, budget reporting, and spending accountability."
  },
  governance: {
    title: "Cost Visibility & Governance",
    description: "Introduce clearer governance controls, spending guardrails, tagging discipline, cost alerts, and policy enforcement."
  },
  rightsizing: {
